...
1. If you were to describe semantic HTML to the next cohort of students, what would you say? semantic HTML shows the meaning of the markup rather than just naming tags anything; helps with accessibility

2. What are the 4 areas of the box model? content, padding, margin, border

3. While using flexbox, what axis does the following property work on: ```align-items: center```?y-axis

4. Explain why git is valuable to a team of developers: teams can use git so they can simultaneously be working together on the same project and be able to see what changes have been made, as well as pinpoint where something might have broken

5. Define mobile-first design in your own words. Mobile-first design is the process of starting with the smallest screen and designing up from there, rather than starting with the desktop-sized screen and working down, since many users user their mobile devices for the majority of browsing
